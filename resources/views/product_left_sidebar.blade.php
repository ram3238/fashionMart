...
<!-- Mirrored from maraviyainfotech.com/projects/ekka/ekka-v37/ekka-html/product-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Aug 2024 10:15:24 GMT -->
<head>
     <meta charset="UTF-8">
                                ...
                                <li class="dropdown position-static"><a href="javascript:void(0)">Categories</a>
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            ...
                                            <ul class="d-block">
                                                <li class="menu_title"><a href="javascript:void(0)">{{ $category->category_name }}</a></li>
